...
export class TaskQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Filter tasks from this date', example: '2024-01-15T00:00:00.000Z' })
  @IsOptional()
  @IsDateString()
  startDate?: string;

  @ApiPropertyOptional({ description: 'Filter tasks to this date', example: '2024-01-31T23:59:59.000Z' })
  @IsOptional()
  @IsDateString()
  endDate?: string;

  @ApiPropertyOptional({ description: 'Number of tasks to return', example: 10, minimum: 1, maximum: 100 })
  @IsOptional()
  @Transform(({ value }) => parseInt(value))
  @IsNumber()
  @Min(1)
  ...
  @ApiPropertyOptional({ description: 'Number of tasks to skip', example: 0, minimum: 0 })
  @IsOptional()
  @Transform(({ value }) => parseInt(value))
  @IsNumber()
  @Min(0)
